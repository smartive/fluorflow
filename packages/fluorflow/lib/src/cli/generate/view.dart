...
class View extends BaseCommand {
  ...
  Future run() async {
    ...
    final (name, baseViewDirectory, testDirectory) = switch (args.rest) {
      ...
      [final _, final _] when !args.noTests =>
      ...
      _ =>
        throw UsageException(
          'At least the name of the view must be provided.',
          usage,
        ),
    };
  ...
  Library _viewModel(String name) => Library(
    (b) => b.body.add(
      Class(
        (b) =>
            b
  ...
  Library _view(String name, String viewModelFile) => Library(
    (b) => b.body.add(
      Class(
        (b) =>
            b
              ...
              ..modifier = ClassModifier.final$
              ..annotations.add(
                refer('Routable()', 'package:fluorflow/annotations.dart'),
              )
